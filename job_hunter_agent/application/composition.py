    ...
    return JobCollectionService(
        ...
        site_collector=BrowserUseSiteCollector(
            ...
            linkedin_collector=LinkedInDeterministicCollector(
                ...
                search_queries=getattr(settings, "linkedin_search_queries", ()),
                search_queries_per_cycle=getattr(settings, "linkedin_search_queries_per_cycle", 3),
                search_experience_levels=getattr(settings, "linkedin_search_experience_levels", ("2", "3")),
                search_workplace_types=getattr(settings, "linkedin_search_workplace_types", ("2", "3")),
                search_easy_apply_only=getattr(settings, "linkedin_search_easy_apply_only", True),
                search_recency_seconds=getattr(settings, "linkedin_search_recency_seconds", 604800),
                search_sort_by=getattr(settings, "linkedin_search_sort_by", "DD"),
                known_job_url_exists=known_job_lookup,
